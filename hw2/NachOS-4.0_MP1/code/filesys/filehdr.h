...
#define NumDirect ((SectorSize - (2 + NumIndirect) * sizeof(int)) / sizeof(int))
#define SectorNumInsideIndirect (SectorSize / sizeof(int) - 1)
...
private:
  int numSectors;
  int dataSectors[SectorNumInsideIndirect];
};
